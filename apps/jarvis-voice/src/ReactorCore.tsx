...
const PALETTES: Record<ReactorState, Palette> = {
  idle: { primary: "105, 150, 210", secondary: "135, 170, 220", accent: "218, 232, 250", glow: "120, 175, 235" },
  online: { primary: "42, 125, 255", secondary: "80, 170, 255", accent: "232, 246, 255", glow: "70, 150, 255" },
  listening: { primary: "80, 170, 255", secondary: "42, 125, 255", accent: "236, 248, 255", glow: "92, 190, 255" },
  speaking: { primary: "238, 122, 92", secondary: "255, 188, 108", accent: "255, 250, 230", glow: "255, 154, 104" },
  working: { primary: "90, 145, 255", secondary: "80, 190, 255", accent: "235, 246, 255", glow: "105, 165, 245" },
};
...
export default function ReactorCore({
  ...
  useEffect(() => {
    ...
    function draw(time: number) {
      ...
      // Live audio level (mic in / voice out) reacts fast on top of the smooth
